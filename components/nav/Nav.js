...
const Nav = () => {
  return (
    <>
      <nav className={styles.navBar}>
        <ul className={styles.linksExemplo}>
          <li>
            <Link href="/contato">
              <a>Contato</a>
            </Link>
      ...
      <div className={`${styles.movelNav} ${styles.exemploBackground}`}>
  ...
  x="0px"
  y="0px"
  viewBox="0 0 505.709 505.709"
>
  <path
    d="M427.554,71.862c-99.206-95.816-256.486-95.816-355.692,0c-98.222,101.697-95.405,263.762,6.292,361.984
  ...
  />
  <path
    d="M396.641,325.729l-47.957-47.787c-10.884-10.91-28.552-10.931-39.462-0.047c-0.016,0.016-0.031,0.031-0.047,0.047
  ...
  />
          ...
          <div className={styles.movelNav__sessao}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217.51 173.54">
              <rect
                x="18.2"
                y="19.95"
                width="181.11"
